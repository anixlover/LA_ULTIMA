    ...
    public partial class Inspeccionar_Catalogo : System.Web.UI.Page
    {
        ...
        public void mostrarTodos()
        {
            ...
            foreach (DataRow row in dt.Rows)
            {
                ...
                _log.CustomWriteOnLog("InspeccionarCatalogo_mostrarTodos", "PK_IM_Cod : " + PK_IM_Cod);
                //_log.CustomWriteOnLog("BaquetonC", "DM_Medida : " + DM_Medida);
                //_log.CustomWriteOnLog("BaquetonC", "VTM_UnidadMetrica : " + VTM_UnidadMetrica);
                _log.CustomWriteOnLog("InspeccionarCatalogo_mostrarTodos", "DM_Precio : " + DM_Precio);
                _log.CustomWriteOnLog("InspeccionarCatalogo_mostrarTodos", "VM_Descripcion : " + VM_Descripcion);
        ...
        protected void btnBaquetonClasico_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _log.CustomWriteOnLog("InpeccionarCatalogoBaqueton", "objDtoTipoMoldura.PK_ITM_Tipo : " + objDtoTipoMoldura.PK_ITM_Tipo);
                DataTable dt = new DataTable();
                dt = objCtrMoldura.ListarMoldurasPaginaInicial(objDtoTipoMoldura);
                string Image1;
                string HtmlRepeater = "";
                string cs = ConfigurationManager.ConnectionStrings["conexion"].ConnectionString;
                _log.CustomWriteOnLog("InpeccionarCatalogoBaqueton", "Flag 2");
                ...
                foreach (DataRow row in dt.Rows)
                {
                    ...
                    string VM_Descripcion = row["VM_Descripcion"].ToString();
                    string VTM_Nombre = row["VTM_Nombre"].ToString();
                    _log.CustomWriteOnLog("InpeccionarCatalogoBaqueton", "=================================");
                    _log.CustomWriteOnLog("InpeccionarCatalogoBaqueton", "PK_IM_Cod : " + PK_IM_Cod);
                    ...
                    _log.CustomWriteOnLog("InpeccionarCatalogoBaqueton", "DM_Precio : " + DM_Precio);
                    _log.CustomWriteOnLog("InpeccionarCatalogoBaqueton", "VM_Descripcion : " + VM_Descripcion);
                    _log.CustomWriteOnLog("InpeccionarCatalogoBaqueton", "=================================");
                ...
                _log.CustomWriteOnLog("InpeccionarCatalogoBaqueton", "Flag 3");
            }
            catch (Exception ex)
            {
                _log.CustomWriteOnLog("InpeccionarCatalogoBaqueton", "Error :" + ex.Message + "StackTrace" + ex.StackTrace);
            }
        }
