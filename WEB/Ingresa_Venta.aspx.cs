...
namespace WEB
{
    public partial class Ingresa_Venta : System.Web.UI.Page
    {
        ...
        protected void ddl_TipoComprobante_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                ddlListRUC.Visible = false;
                lblRUCnuevo.Visible = false;

            }
            else
            {
                ddlListRUC.Visible = true;
                lblRUCnuevo.Visible = true;
            }
        ...
        protected void btnBuscarDocumento_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                objuser.PK_VU_Dni = txtDocumento.Text;
                objdtofac.FK_VU_Dni = txtDocumento.Text;
                objctrusr.TraeData(objuser);
                txtNombre.Text = objuser.VU_Nombre;
        ...
        protected void ddl_Ruc_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        protected void btnIngresarRuc_Click(object sender, EventArgs e)
        {
            if (txtIngresarRuc.Text == "")
            {
                Utils.AddScriptClientUpdatePanel(updBotonEnviar, "showSuccessMessage16()");
                return;
            }
            objdtofac.FK_VU_Dni = txtDocumento.Text;
            objdtofac.VDF_Ruc = txtIngresarRuc.Text;
        ...
        protected void btnagregar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt.Rows.Add(txtCodProducto.Text, txtCantidadProducto.Text, DM_Precio2, Subtotal);
                gv2.DataSource = dt;
                gv2.DataBind();
        ...
        protected void btnIngresarProducto_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                objDtoMoldura.PK_IM_Cod = Convert.ToInt32(txtCodProducto.Text);
        ...
        protected void btnCalcularPersonalizado_Click(object sender, EventArgs e)
        {
            ...
            if (txtCantidadPersonalizado.Text == "")
            {
            ...
            if (ddlTipoMoldura.SelectedValue != "0")
            {
                ...
                int cantp = int.Parse(txtCantidadPersonalizado.Text);
        ...
        {
            if (txtDocumento.Text == "" | txtLargo.Text == "" | txtCantidadPersonalizado.Text == "")
            {
                Utils.AddScriptClientUpdatePanel(updBotonEnviar, "showSuccessMessage7()");
                return;
            }
            ...
            try
            {
                if (valorObtenidoRBTN.Value == "2" && ddlPedidoPor.SelectedValue == "2")
                {
                    ...
                    objDtoSolicitud.DS_Largo = int.Parse(txtLargo.Text);
                    _log.CustomWriteOnLog("RealizarVenta", "objDtoSolicitud.DS_Medida " + objDtoSolicitud.DS_Largo);
                    objDtoSolicitud.DS_Ancho = int.Parse(txtAncho.Text);
        ...
        protected void btnIngresarCantidad_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (cantidad <= IM_Stock)
                {
                    ...
                    objDtoMoldura.PK_IM_Cod = Convert.ToInt32(txtCodProducto.Text);
                    double subtotal = Convert.ToDouble(txtCantidadProducto.Text);
